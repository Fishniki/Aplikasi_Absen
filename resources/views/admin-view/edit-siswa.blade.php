            ...
            <div class="flex gap-5">
                <div class="mb-4 w-full">
                    ...
                    <select
                        ...
                        <option value="10" {{ old('kelas', $siswa_byid->kelas) == '10' ? 'selected' : '' }}>X</option>
                        <option value="11" {{ old('kelas', $siswa_byid->kelas) == '11' ? 'selected' : '' }}>XI</option>
                        <option value="12" {{ old('kelas', $siswa_byid->kelas) == '12' ? 'selected' : '' }}>XII</option>
                    </select>
                ...
                <div class="mb-4 w-full">
                    ...
                    <select
                        ...
                        <option value="RPL" {{ old('kelas', $siswa_byid->jurusan) == 'RPL' ? 'selected' : '' }}>RPL</option>
                        <option value="DKV" {{ old('kelas', $siswa_byid->jurusan) == 'DKV' ? 'selected' : '' }}>DKV</option>
                        <option value="AKL-I" {{ old('kelas', $siswa_byid->jurusan) == 'AKL-I' ? 'selected' : '' }}>AKL-I</option>
                        <option value="AKL-II" {{ old('kelas', $siswa_byid->jurusan) == 'AKL-II' ? 'selected' : '' }}>AKL-II</option>
                        <option value="OTKP" {{ old('kelas', $siswa_byid->jurusan) == 'OTKP' ? 'selected' : '' }}>OTKP</option>
                        <option value="BR" {{ old('kelas', $siswa_byid->jurusan) == 'BR' ? 'selected' : '' }}>BR</option>
                ...
                <div class="flex items-center gap-5">
                    <label class="flex items-center gap-2">
                        <input id="jk_checkbox" type="checkbox" name="jenis_kelamin" value="Laki-laki"
                            ...
                            {{ old('jenis_kelamin', $siswa_byid->jenis_kelamin) == 'Laki-laki' ? 'checked' : '' }}>
                        <span>Laki-laki</span>
                    </label>
                    ...
                    <label class="flex items-center gap-2">
                        <input id="jk_checkbox" type="checkbox" name="jenis_kelamin" value="Perempuan"
                            class="border rounded-md focus:ring focus:ring-blue-200 @error('jenis_kelamin') border-red-500 @enderror"
                            {{ old('jenis_kelamin', $siswa_byid->jenis_kelamin) == 'Perempuan' ? 'checked' : '' }}>
                        <span>Perempuan</span>
                    </label>
                </div>
