    ...
    <div class="min-h-screen flex items-center justify-center">
        <div class=" rounded-lg p-8 w-full max-w-4xl flex flex-col md:flex-row">
            ...
            <div class="w-full md:w-1/2 mb-8 md:mb-0">
                ...
                <form method="POST" action="{{ route('admin.store-edit', $user->id) }}">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <input type="nama" id="nama" name="nama" placeholder="John Doe"
                            class="w-full mt-1 p-2 border rounded focus:outline-none focus:ring focus:border-blue-300 @error('nama') border-red-500 @enderror"
                            value="{{ $user->name }}">
                        @error('nama')
